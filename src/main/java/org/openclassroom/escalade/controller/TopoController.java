...
public class TopoController {
	...
	public String update(HttpServletRequest request) {
		...
		if (id==null|| id.equals("")) {
			...
			if (topoBo.getDisponible()== DispoEnum.Indisponible.getNum()) {
			ReservationBo reservationBo = reservationService.archiveReservation(Integer.parseInt(request.getParameter("id")));	
			topoBo.setNom(nom);
			topoBo.setDescription(description);
			topoBo.setLieu(lieu);
			SimpleDateFormat  sdf = new SimpleDateFormat("yyyy-MM-dd");
			...
			ReservationBo reservationBo = reservationService.validerReservation(Integer.parseInt(request.getParameter("id")));
			topoBo.setNom(nom);
			topoBo.setDescription(description);
			topoBo.setLieu(lieu);
			SimpleDateFormat  sdf = new SimpleDateFormat("yyyy-MM-dd");
